...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Infinity View Academy" },
      { property: "og:title", content: "Infinity View Academy" },
      { property: "og:description", content: "Learning Today, Leading Tomorrow — A modern CBC institution preparing learners for a bright future." },
